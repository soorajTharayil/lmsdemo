                            ...
                            <div class="scrollable-tab-section" id="basicwizard">
                                ...
                                <div class="scrollable-tab">
                                    <ul class="nav nav-pills nav-justified form-wizard-header" style="flex-wrap: unset;">
                                        <li class="nav-item">
                                            <a href="#basic" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2" style="min-width: 550px;">
                                        ...
                                        <li class="nav-item">
                                            <a href="#finish" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2" style="min-width: 550px;">
