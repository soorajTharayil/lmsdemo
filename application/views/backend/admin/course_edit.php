                            ...
                            <div class="scrollable-tab-section" id="basicwizard">
                                ...
                                <div class="scrollable-tab">
                                    <ul class="nav nav-pills nav-justified form-wizard-header">
                                        <li class="nav-item">
                                            <a href="#curriculum" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2" style="min-width: 275px;">
                                                <i class="mdi mdi-account-circle"></i>
                                                <span class=""><?php echo get_phrase('curriculum'); ?></span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a style="min-width: 275px;" href="#academic_progress" onclick="student_academic_progress('<?php echo $course_details['id']; ?>')" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                        ...
                                        <li class="nav-item">
                                            <a style="min-width: 275px;" href="#basic" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                        ...
                                        <li class="nav-item">
                                            <a style="min-width: 275px;" href="#finish" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
